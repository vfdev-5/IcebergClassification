...
if __name__ == "__main__":
    ...
    print("\nStart train squeezenet model\n")
    parser = argparse.ArgumentParser(description="Train squeezenet model")
    ...
    now = datetime.now()
    output_path = os.path.abspath(os.path.join("..", "output", "logs_squeezenet_%s" % now.strftime("%Y%m%d_%H%M")))
